        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card p-4 shadow">
                    ...
                    <!-- Form Edit Admin -->
                    <form action="<?= base_url('admin/update_admin/' . $user['id']) ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control <?= (isset($validation) && $validation->hasError('email')) ? 'is-invalid' : '' ?>" id="email" name="email" value="<?= esc($user['email']) ?>">
